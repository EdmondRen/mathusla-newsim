...
int main(int argc, const char *argv[])
{
    ...
    auto input_reader = std::make_unique<Tracker::TreeReaderDigi_old>(input_filename.string());
    auto output_writer = std::make_unique<Tracker::TreeWriterRecon_old>(output_filename.string(), input_filename.string(), args["rawfile"].as<std::string>(), save_raw_reduced);
