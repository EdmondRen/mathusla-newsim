...
for p in "${DATA_DIR}/genie/genie_output_2025_10/genie_output_atmos/run_*_source.root"; do
    FILENAME_LIST+=($p)
done
...
for i in $SLURM_ARRAY_TASK_ID; do
    ...
    data_dir_this="${DATA_DIR}/genie/genie_output_2025_10/g4_output_atmos/${filename_noext:0:-7}/"
