...
for p in "${DATA_DIR}/genie/genie_output_2025_10/g4_output/run_*/run_0_digionly_recon_skim.root"; do
    FILENAME_LIST+=($p)
done
merged_file_name="$DATA_DIR/genie/genie_output_2025_10/g4_output/recon_skim_merged.root"
