...
RUN_NUMBER=${1}
RUN_TIME=8640000 # seconds, 100 days of exposure. Should take 8*100/60 ~ 14 hours
...
-f $SIM_CODE_DIR/studies/mathusla40/lhc_neutrino/flux_data/combined_flux.root,12[NHLLHCνeAtEachEnergyGeV],-12[NHLLHCνeAtEachEnergyGeV] \
...
# [prefix].[run_number].[event_tree_format].[file_format]
$GENIE/bin/gevgen_flux \
-f $SIM_CODE_DIR/studies/mathusla40/lhc_neutrino/flux_data/combined_flux.root,14[NHLLHCνμAtEachEnergyGeV],-14[NHLLHCνμAtEachEnergyGeV] \
-T $RUN_TIME    -r $RUN_NUMBER --seed  $RUN_NUMBER  -o $DATA_DIR/gntp \
-g $GENIE_DATA_DIR/geometry/world.box.root \
--cross-sections $GENIE_DATA_DIR/genie_xsec/v3_04_00/NULL/G1802a00000-k250-e1000/data/gxspl-NUsmall.xml \
 --message-thresholds $GENIE/config/Messenger_laconic.xml
...
# [prefix].[run_number].[event_tree_format].[file_format]
$GENIE/bin/gevgen_flux \
-f $SIM_CODE_DIR/studies/mathusla40/lhc_neutrino/flux_data/combined_flux.root,14[NHLLHCHardνμAtEachEnergyGeV],-14[NHLLHCHardantiνμAtEachEnergyGeV] \
-T $RUN_TIME    -r $RUN_NUMBER  --seed  $RUN_NUMBER  -o $DATA_DIR/gntp  -E 0.3,2000 \
-g $GENIE_DATA_DIR/geometry/world.box.root \
--cross-sections $GENIE_DATA_DIR/genie_xsec/v3_04_00/NULL/G1802a00000-k250-e1000/data/gxspl-NUsmall.xml \
 --message-thresholds $GENIE/config/Messenger_laconic.xml
...
# [prefix].[run_number].[event_tree_format].[file_format]
$GENIE/bin/gevgen_flux \
-f $SIM_CODE_DIR/studies/mathusla40/lhc_neutrino/flux_data/combined_flux.root,14[NHLLHCBtoνμAtEachEnergyGeV],-14[NHLLHCBtoνμAtEachEnergyGeV] \
-T $RUN_TIME    -r $RUN_NUMBER  --seed  $RUN_NUMBER  -o $DATA_DIR/gntp \
-g $GENIE_DATA_DIR/geometry/world.box.root \
--cross-sections $GENIE_DATA_DIR/genie_xsec/v3_04_00/NULL/G1802a00000-k250-e1000/data/gxspl-NUsmall.xml \
 --message-thresholds $GENIE/config/Messenger_laconic.xml
